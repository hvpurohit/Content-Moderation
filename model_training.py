# train_english_binary_toxic_stepwise.py
# Step-by-step evaluation to improve accuracy & precision while preserving recall
# - English-only DistilBERT (uncased)
# - Class weights + WeightedRandomSampler
# - Adaptive eval_steps (~8-10 evals per epoch)
# - Early stopping (patience=4) on F1 + load best model at end
# - Warmup + cosine schedule to reduce metric oscillations
# - Dev-set threshold tuning with precision-weighted objective (0.6P/0.4R)
# - Saves model, threshold, logs, and plots
